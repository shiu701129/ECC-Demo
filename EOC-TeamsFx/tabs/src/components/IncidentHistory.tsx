...
export class IncidentHistory extends React.PureComponent<
  IIncidentHistoryProps,
  IIncidentHistoryState
> {
  ...
  exportToExcel = async () => {
    ...
    let exportData = this.state.gridData.map((item, i) => {
      return {
        modifiedDate: item.modifiedDate ? item.modifiedDate : "",
        lastModifiedBy: item.lastModifiedBy ? item.lastModifiedBy : "",
        incidentName: item.incidentName ? item.incidentName : "",
        status: item.status ? item.status : "",
        severity: item.severity ? item.severity : "",
        location: item.location ? item.location : "",
        incidentCommander: item.incidentCommander ? item.incidentCommander : "",
        incidentDescription: item.incidentDescription ? item.incidentDescription : "",
        reasonForUpdate: item.reasonForUpdate ? item.reasonForUpdate : "",
        // 日期: item.modifiedDate ? item.modifiedDate : "",
        // 修改者: item.lastModifiedBy ? item.lastModifiedBy : "",
        // 事件名稱: item.incidentName ? item.incidentName : "",
        // 事件狀態: item.status ? item.status : "",
        // 嚴重性: item.severity ? item.severity : "",
        // 位置: item.location ? item.location : "",
        // 事件指揮官: item.incidentCommander ? item.incidentCommander : "",
        // 描述: item.incidentDescription ? item.incidentDescription : "",
        // 更新原因: item.reasonForUpdate ? item.reasonForUpdate : "",
      };
    });
    ...
    FileSaver.saveAs(
      data,
      `${this.props.localeStrings.incidentHistory}-${
        this.state.gridData[this.state.gridData.length - 1].incidentName
      }-${this.props.incidentId}.xlsx`
    );
  };
  ...
  private async getVersions() {
    try {
      ...
      this.dataService.trackException(
        ...
        error,
        constants.componentNames.IncidentHistoryComponent,
        "IncidentHistory_Get_Versions",
  ...
  private formatVersionData(versionData: any, index: any) {
    try {
      ...
      changes.forEach((item: any) => {
        if (
          item.path[0] !== constants.modifiedDate &&
          ...
          const pascalCaseText = item.path[0]
            .replace(/(A-Z)/g, " $1")
            .replace(/([A-Z][a-z])/g, " $1");
      ...
      this.dataService.trackException(
        ...
        error,
        constants.componentNames.IncidentHistoryComponent,
        "IncidentHistory_Format_Version_Data",
        this.props.userPrincipalName
      );
    }
  }
  ...
  private formatGridData() {
    try {
      ...
      this.dataService.trackException(
        ...
        error,
        constants.componentNames.IncidentHistoryComponent,
        "IncidentHistory_Format_Grid_Data",
        this.props.userPrincipalName
      );
    }
  }
  ...
  private onRenderCell(item: any, index: number | undefined): JSX.Element {
    return (
      <div
        ...
        className={`activity-log-list-item${
          this.state.selectedItem === index ? " activity-log-list-item-selected" : ""
        }`}
      ...
      ? [
          {
            ...
            isResizable: true,
            onRenderHeader: () => (
              <span title={this.props.localeStrings.field}>{this.props.localeStrings.field}</span>
            ),
          ...
          },
          {
            ...
            isResizable: true,
            onRenderHeader: () => (
              <span title={this.props.localeStrings.new}>{this.props.localeStrings.new}</span>
            ),
          ...
          },
          {
            ...
            isResizable: true,
            onRenderHeader: () => (
              <span title={this.props.localeStrings.old}>{this.props.localeStrings.old}</span>
            ),
      ...
      ? [
          {
            ...
            columns: [
              {
                Header: () => (
                  <div title={this.props.localeStrings.date}>{this.props.localeStrings.date}</div>
                ),
              ...
              {
                Header: () => (
                  <div title={this.props.localeStrings.modifiedBy}>
                    {this.props.localeStrings.modifiedBy}
                  </div>
                ),
          ...
          },
          {
            columns: [
              {
                Header: () => (
                  <div title={this.props.localeStrings.fieldIncidentName}>
              ...
              {
                Header: () => (
                  <div title={this.props.localeStrings.fieldIncidentStatus}>
                    {this.props.localeStrings.fieldIncidentStatus}
                  </div>
                ),
                accessor: "status",
                Cell: ({ value }: any) => (value ? <span title={value}>{value}</span> : ""),
              ...
              {
                Header: () => (
                  <div title={this.props.localeStrings.fieldSeverity}>
              ...
              {
                Header: () => (
                  <div title={this.props.localeStrings.fieldLocation}>
                    {this.props.localeStrings.fieldLocation}
                  </div>
                ),
                accessor: "location",
                Cell: ({ value }: any) => (value ? <span title={value}>{value}</span> : ""),
              ...
              {
                Header: () => (
                  <div title={this.props.localeStrings.fieldIncidentCommander}>
              ...
              {
                Header: () => (
                  <div title={this.props.localeStrings.roles}>{this.props.localeStrings.roles}</div>
                ),
              ...
              {
                Header: () => (
                  <div title={this.props.localeStrings.fieldDescription}>
              ...
              {
                Header: () => (
                  <div title={this.props.localeStrings.fieldReasonForUpdate}>
                    {this.props.localeStrings.fieldReasonForUpdate}
                  </div>
                ),
          ...
          <div className=".col-xs-12 .col-sm-8 .col-md-4 container" id="incident-history-path">
            <label>
              <span onClick={() => this.props.onBackClick(false)} className="go-back">
                ...
                <span className="back-label" title={this.props.localeStrings.back}>
                  {this.props.localeStrings.back}
                </span>
              </span>{" "}
              &nbsp;&nbsp;
              <span className="right-border">|</span>
              <span title={this.props.localeStrings.incidentHistory}>
                &nbsp;&nbsp;{this.props.localeStrings.incidentHistory}
              </span>
            </label>
          </div>
          <div className="incident-history-area">
            <div className="container">
              <div className="heading-and-view-selection-area">
                <div className="incident-history-label">
                  {this.props.localeStrings.incidentHistory} - {this.props.incidentId}
                </div>
                <div className="view-selection-area">
                  <label
                    htmlFor="list-view-select"
                    className="flip-view"
                    title={this.props.localeStrings.listView}
                  >
                    <input
                      type="radio"
                      name="select view"
                  ...
                  <label
                    htmlFor="table-view-select"
                    className="flip-view"
                    title={this.props.localeStrings.tableView}
                  >
                    <input
                      type="radio"
                      name="select view"
                  ...
                  {!this.state.isListView && this.state.gridData.length > 0 && (
                    <Button primary onClick={(e) => this.exportToExcel()}>
                      {this.props.localeStrings.exportExcel}
                    </Button>
                  )}
                </div>
              </div>
                ...
                <div className="activity-version-details-area">
                  <div className="activity-log-area">
                    <div
                      ...
                      title={this.props.localeStrings.activityLog}
                    >
                      {this.props.localeStrings.activityLog}
                    </div>
                    <div className="activity-log-list-main-area" data-is-scrollable>
                      {this.state.incidentVersionData !== undefined && (
                        <List
                          ...
                          items={this.state.incidentVersionData.slice(
                            0,
                            this.state.seeAllVersions
                              ? this.state.incidentVersionData.length
                              : constants.listViewItemInitialCount
                          )}
                          onRenderCell={this.onRenderCell}
                          className="activity-log-list-main"
                          getPageHeight={(idx) =>
                            this.dataService.getPageHeight(
                              idx,
                              this.itemHeight,
                              this.numberOfItemsOnPage
                            )
                          }
                      ...
                      <>
                        {this.state.versionDetails.length !== undefined ? (
                          <div
                            ...
                            title={this.props.localeStrings.noVersionChangesLabel}
                          >
                          ...
                          <div
                            className="noDataFound"
                            title={this.props.localeStrings.loadingLabel}
                          >
                      ...
                      cancelButton={{
                        icon: (
                          <CloseIcon
                            ...
                            circular
                            size="smallest"
                            className="roles-popup-btn-close-icon"
                          />
                        ),
