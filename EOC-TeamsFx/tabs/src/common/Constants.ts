...
export const maxCharLengthForTemplateName = 20;
export const maxCharLengthForChannelName = 20;
export const maxCharLengthForWebName = 20;
export const maxCharLengthForCusAppName = 20;
export const maxWebTabCount = 3;
export const maxCusAppCount = 3;
...
export const componentNames = {
  ...
  ChannelTemplateComponent: 'ChannelTemplate',
  ChannelSettingComponent: 'ChannelSetting',
